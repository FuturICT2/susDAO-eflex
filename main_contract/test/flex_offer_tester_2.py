...
deployed_offer_address = '0x1E4Fc0Fa166b945de4e5d17379f78B3b8F367a6c'
...
def one_run():
    ...
    contract_balance = web3_A.eth.getBalance(deployed_offer_address)
    print ("contract_balance withdraw success: " + str(contract_balance)) 
    ...
    contract_balance = web3_A.eth.getBalance(deployed_offer_address)
    print ("contract_balance withdraw failed: " + str(contract_balance))
